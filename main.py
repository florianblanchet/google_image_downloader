# Source https://github.com/krishnac7/Google-image-grabber
...
def parseArg():
    ...
    config['query'] = parsed.query if parsed.query != '' else input("Image à rechercher: ")
...
def getImageList():
    ...
    print("Enregistrement dans le dossier: .photos > "+query.split()[0])
...
def main():
    ...
    for x in threads:
        x.join()
    print('\x1b[6;30;42m' + 'Terminé!' + '\x1b[0m\n')
